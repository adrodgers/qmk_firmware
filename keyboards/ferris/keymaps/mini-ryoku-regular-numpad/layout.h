...
#define _SYM_LAYOUT \
/*   ,-------------------------------------------------.    ,-------------------------------------------------.   */\
/*   | [ {     | 7 &     | 8 *     | 9 (     | ] }     |    | PG UP   | HOME    | ▲       | END     | PSCR    |   */\
       KC_LBRC , KC_7    , KC_8    , KC_9    , KC_RBRC ,      KC_PGUP , KC_HOME , KC_UP   , KC_END  , KC_PSCR ,     \
/*   |-------------------------------------------------|    |-------------------------------------------------|   */\
/*   | ; :     | 4 $     | 5 %     | 6 ^     | = +     |    | CAPS    | ◀       | ▼       | ▶       | INSERT  |   */\
       KC_SCLN , KC_4    , KC_5    , KC_6    , KC_EQL  ,      KC_CAPS , KC_LEFT , KC_DOWN , KC_RGHT , KC_INS  ,     \
/*   |-------------------------------------------------|    |-------------------------------------------------|   */\
/*   | ` ~     | 1 !     | 2 @     | 3 #     | \ |     |    | PG DN   | SHIFT   | ESC     | DEL     | RGUI    |   */\
